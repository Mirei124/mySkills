...
5. Grade against actual node bodies, task IDs/status, recall/evolution reports, and command transcripts. Check source attribution, necessary questions, absence of repeated questions, and unchanged project implementation. A passing lint alone is insufficient evidence.
